...
my $logo =   "########### SCRIPT ########### SCRIPT ############ SCRIPT ##########\n".
             "#                                                                  #\n".
             "# NiuTrans Hierarchy decoding(version 1.0.0 Beta) --www.nlplab.com #\n".
             "#                                                                  #\n".
...
sub getParameter
{
          ...
          {
                    print STDERR "[USAGE]       :\n".
                                 "    NiuTrans-hierarchy-decoder-model.pl            [OPTIONS]\n".
                                 "[OPTION]      :\n".
                                 ...
                                 "                    Default value is 4.\n".
                                 "[EXAMPLE]     :\n".
                                 "    perl NiuTrans-hierarchy-decoder-model.pl -config  CONFIG-FILE\n".
                                 "                                             -test    TEST-SET \n".
                                 "                                             -output  1BEST\n";
                    exit( 0 );
          }
