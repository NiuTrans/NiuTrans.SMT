...
#######################################
#   version      : 1.0.0 Beta
#   Function     : NiuTrans Syntax MERT
#   Author       : Qiang Li
#   Email        : liqiangneu@gmail.com
#   Date         : 06/09/2011
#   Last Modified: 
#        Rewrite this file by QiangLi at 2012-06-05.
...
my $logo =   "########### SCRIPT ########### SCRIPT ############ SCRIPT ##########\n".
             "#                                                                  #\n".
             "#   NiuTrans Syntax MERT (version 1.0.0 Beta)   --www.nlplab.com   #\n".
             "#                                                                  #\n".
...
sub experiment_maxWeight
{
          ...
          {
                    ++$round;
#                    my $exec = "../bin/NiuTrans.Decoder -mert $param{ \"-dev\" } -config $param{ \"-config\" } 1 $param{ \"-nref\" } $param{ \"-ngram\" } $param{ \"-nthread\" }";
                    ...
                    {
                    #          $exec = $exec." -syntax -tree2tree -treeparsing -replacefoctoid 1 -nogrammarencoding ";
...
sub getParameter
{
          ...
          {
                    print STDERR "[USAGE]     :\n".
                                 "    NiuTrans-syntax-mert-model.pl                   [OPTIONS]\n".
                                 "[OPTION]    :\n".
                                 ...
                                 "                   Default \"avg\".\n".
                                 "    -nref   :  Reference number of dev set.        [optional]\n".
                                 ...
                                 "[EXAMPLE]   :\n".
                                 "    perl NiuTrans-syntax-mert-model.pl   -model   [MODEL-VAL]\n".
                                 "                                         -config  [CONF-FILE]\n".
                                 "                                         -dev     [DEV-SET  ]\n";
